 ...
 *
 * photo:  filnavnet i public/team/. Utelat feltet, eller sett det til
 *         null, så viser kortet «Bilde kommer» i stedet.
 * tags:   fagområdene som vises under navnet, f.eks. ['Full-stack', 'Database'].
 *         Tom liste = ingen linje under navnet.
...
export const team: Member[] = [
  ...
  },
  {
    ...
    links: {
      github: 'https://github.com/fjelise',
